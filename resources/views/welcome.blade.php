...
<body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
          <img src="/img/energeek.png" alt="Nama Gambar">
        </div>
                ...
                <form action="{{ route('store') }}" method="post">
                  @csrf
                    ...
                    <div class="input-group mb-3">
                        <input name="name" type="text" class="form-control" placeholder="Cth: Jhonatan Akbar">
                    ...
                    <label>Jabatan :</label>
                    <div class="input-group mb-3">
                        <select name="job_id" class="form-control select2" style="width: 100%"; data-placeholder="Pilih Jabatan"">
                          @foreach ($job as $jobs)
                    ...
                    <label>Telepon :</label>
                    <div class="input-group mb-3">
                        <input name="phone" type="number" class="form-control" placeholder="Cth: 0893239851289">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3 date" id="reservationdate" data-target-input="nearest">
                        <input name="year" type="text" class="form-control datetimepicker-input" data-target="#reservationdate" placeholder="Pilih Tahun"/>
